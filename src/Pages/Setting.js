...
function Setting() {
    ...
    const updateProfile = async (formData) => {
        if (formData) {
            await requests
                .post(`update-profile`, formData, { token: authHeader() })
                .then((res) => {
                    if (res) {
                        notify(res.message);
                    } else {
    ...
    const updatePassword = async (passwordData) => {
        if (passwordData) {
            await requests
                .post(`change-password`, passwordData, { token: authHeader() })
                .then((res) => {
                    if (res) {
                        notify(res.message);
                    } else {
                                            ...
                                            <div className="prf_lft">
                                                ...
                                                <div className="prf_data_box">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="input">
                                                            <div
                                                                className={`nice-select selectize data-input ${
                                                                    !countriField
                                                                        ? "disabled"
                                                                        : ""
                                                                } ${
                        ...
                        <div className="dashboard_profs_row_rtt">
                            <div className="dashboard_rt_fltd">
                                <div className="dashboard_rt_fltd_wrap">
                                    <figure className="main_img">
                                        <img
                                            src="images/tripati_logo.png"
                                            alt=""
                                        />
                                    </figure>
                                    <p>
                                        Please register on Tipalti using the
                                        button Below to Receive Payments From
                                        ViralSnare
                                    </p>
                                    <Link
                                        to={"/login"}
                                        className="reg_btn_part"
                                    >
                                        Register
                                    </Link>
                                </div>
                            ...
                            <div className="dashboard_rt_fltd">
                                <div className="dashboard_rt_fltd_wrap">
                                    ...
                                    <p>
                                        Please login on Tipalti using the button
                                        Below to Receive Payments From
                                        ViralSnare
                                    </p>
                                    <Link
                                        to={"/login"}
