                ...
                <div className="dashboard_content_inner">
                    <div className="head_row">
                        <div className="tab_row">
                            ...
                            >
                                <li>
                                    <a onClick={() => setStatus(STATUS.All)} href="#" className={status == STATUS.All ? 'active' : ''} id="nav_tab_selecton_all">
                                        All Videos
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="filter_row">
                            ...
                            <div className="view_control">
                                <span className={`list_toggle_btn  ${isListView ? 'active' : ''}`} id="list_view" onClick={() => setIsListView(!isListView)}>
                                    <svg
                                        width="34"
                                        height="31"
                                        viewBox="0 0 34 31"
                                ...
                                <span className={`grid_toggle_btn ${isListView ? '' : 'active'}`} id="grid_view" onClick={() => setIsListView(!isListView)}>
                                    <svg
                                        width="29"
                                        height="29"
                                        viewBox="0 0 29 29"
                    ...
                    <div className="pagination_panel">
                        {data?.total >= 12 && <Pagination perPage={12} total={data?.total} currentPage={currentPage} onChange={e => setCurrentPage(e)} />}
                    </div>
                </div>
            </div>
        </>
