            ...
            <div className="dashboard_body dashboard_body_chat_detail">
                <div className="fluid_container">
                                ...
                                <div className="left-panel">
                                    <div className="panel-box">
                                        <div className="single-video-box mb-0">
                                            <video className="video" loop="1" preload="auto" controls=""
                                    ...
                                    <div className="panel-box-info">
                                        <ul className="nav_list_tab" data-tab-target="tabgroup3">
                                            <li><a href="#" className={active==='about-video' ? 'active' :''} onClick={()=>handleActive('about-video')}>About Video</a></li>
                                            <li><a href="#" className={active==='about-user' ? 'active' :''}  onClick={()=>handleActive('about-user')}>About User</a></li>
                                            <li><a href="#"  className={active==='copy' ? 'active' :''}  onClick={()=>handleActive('copy')}>Copyrights Ownership</a></li>
                                            <li><a href="#" className={active==='info' ? 'active' :''}  onClick={()=>handleActive('info')}>Submission Information</a></li>
                                            <li><a href="#" className={active==='status' ? 'active' :''}  onClick={()=>handleActive('status')}>Submission Status</a></li>
                                        </ul>
                                        <div data-tab-parent="tabgroup3">
                                            <div className={active==='about-video' ? 'tab_panel active' :'tab_panel'}>
                                            ...
                                            <div className={active==='about-user' ? 'tab_panel active' :'tab_panel'}>
                    ...
                    data?.inquery?.video?.last_name}</p>
                                            ...
                                            <div className={active==='copy' ? 'tab_panel active' :'tab_panel'}>
                                                <div className="panel-box-info-wrap tab-inner-scroll column-2_2 border-b-0 pb-0">
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Are There People Appearing In The Video?</span> <mark className="stripe-btn-danger">Yes</mark></p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                                    ...
                                                    <div className="panel-box-info-wrap-col"></div>
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Did Anyone Reach You About Using This Video?</span> <mark className="stripe-btn-danger">Yes</mark></p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Please Share With Us The Name Of The Company/Page </span> Company Name/Page</p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Did You Send/Submit/Upload This Video To A Website And/Or Social Media Account </span> <span className="tg grn"><mark className="stripe-btn-danger">Yes A Youtube Account</mark></span></p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                                    ...
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Did You Sign A Licensing Agreement For This Video With Another Company/Page</span> <span className="tg grn"><mark className="stripe-btn-danger">Yes, I Have Signed An Exclusive Agreement</mark></span></p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                            ...
                                            <div className={active==='info' ? 'tab_panel active' :'tab_panel'}>
                                                <div className="panel-box-info-wrap column-3 border-b-0 pb-0">
                                                    <div className="panel-box-info-wrap-col">
                                            ...
                                            <div className={active==='status' ? 'tab_panel active' :'tab_panel'}>
                                                <div className="panel-box-info-wrap column-2_2 border-b-0 pb-0">
                                                    <div className="panel-box-info-wrap-col">
                                                        <p><span>Video Status </span> <mark className="stripe-btn-danger">Rejected</mark></p>
                                                    </div>
                                                    <div className="panel-box-info-wrap-col">
                                ...
                                <div className="right-panel">
                                    ...
                                    <div className="msg_list_sec panel-box-info">
                                        ...
                                        <div className="chat-timeline">
                                            <span className="chat-timeline-date">Tuesday, march 1</span>
                                        </div>
                                        <div className="modal-body-message-lists-wrap">
                                        {data?.messages?.map(message => {
                                            return (
                                                <div>
                                            <div className={auth()?.id === message?.sender?.id ? "message-body sender" :'message-body receiver'}>
                                        ...
                                        <div className="chat-footer_inner">
                                            ...
                                            <div className="chat-footer-right">
                                                ...
                                                <button type="button" className="btn-outline btn-outline-black">Done</button>
                                                <button type="submit" className="btn-outline btn-outline-red">Send</button>
                                            </div>
