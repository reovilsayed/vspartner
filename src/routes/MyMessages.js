...
function MyMessages() {
  ...
  const { data: inquiries, refetch } = useFetch(["inquiries"], `/inquiry`);
              ...
              <tbody>
                {inquiries?.data?.map((inquiry) => {
                  return (
                    <tr key={inquiry?.id}>
                      {inquiry?.created_at && (
                        <td>{plainDateTime(inquiry?.created_at)}</td>
                      )}
                      <td>{inquiry?.subject}</td>
                      <td>{inquiry?.message}</td>
                      <td>
                        <span className="green_text">Pending</span>
                      </td>
                      <td>
                        <Link
                          to={"/chat/" + inquiry?.id}
                          className="already_view"
                          target="_blank"
                        ></Link>
                      </td>
                    </tr>
