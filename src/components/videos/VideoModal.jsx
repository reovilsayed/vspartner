					...
					<div className='fluid_container'>
								...
								<div className='left-panel sticky_box'>
									...
									<div className='panel-box-info'>
												...
												<div className='story-description-info'>
													...
													<div className='story-description-info-content'>
														<div className='overflow_scroll'>
															<p>{video?.description ? video.description : 'Description'}</p>
														</div>
													</div>
												</div>
											</div>
										...
										<div className='btn-wrap inline_popup' data-pop-block='url_note'>
											<a href='#' className='btn-outline btn-outline-blue' data-btn='url_note'>
										...
										<div className='panel-box-info-wrap column-4 border-b-0'>
											<div className='panel-box-info-wrap-col'>
												<p>
													...
													{video?.first_name ? video.first_name : 'Name'}
													{video?.last_name ? video.last_name : ''}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
											...
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Phone Number :</span>+{video?.phone ? video.phone : 'Phone'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
											...
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Paypal Email Address :</span> Jognsmith@Gmail.Com
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Signature : </span> <img src='images/signature.png' className='signs' alt='' />
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
									...
									<div className='panel-box-info panel-box-info-xxs-spacing theaming-red-box'>
										...
										<div className='column-wrap'>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														...
														<mark className='stripe-btn-danger'>{video?.people_appearing}</mark>
													</p>
												</div>
											...
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>The person who filmed this video is </span> {video?.person_who_filmed}
													</p>
												</div>
											</div>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														...
														<mark className='stripe-btn-danger'>{video?.did_anyone_reach}</mark>
													</p>
												</div>
												{video?.share_reach_name && (
													<>
														<div className='panel-box-info-wrap-col m-0'>
															<p>
																<span>Please Share With Us The Name Of The Company/Page:</span> {video?.share_reach_name}
															</p>
														</div>
													</>
												)}
                        ...
                        {video?.submit_place && (
                          <div className='panel-box-info-wrap-col m-0'>
									...
									<div className='panel-box-info panel-box-info-xxs-spacing'>
										...
										<div className='column-wrap'>
											<div className='panel-box-info-wrap column-4'>
												...
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														<span>Country : </span> {video?.country}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Submission date :</span> August 23rd, 2021 at 11:15:34 PM UTC
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
                            ...
                            {video?.status == 1?(
                              <>
                                <span>Video Status : </span> <mark className='stripe-btn-success'>Approved</mark>
                              </>
                            ):(
                              <>
                                <span>Video Status : </span> <mark className='stripe-btn-danger'>Rejected</mark>
                              </>
                            )}
													</p>
												</div>
												...
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>approved or rejected By :</span> Manager Name 22.03.2021 @10:55AM
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Confirmed or declined By :</span> Name of the Quality Team Agent 22.03.2021 @10:55AM{' '}
													</p>
												</div>
											</div>
										</div>
