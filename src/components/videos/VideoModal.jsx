								...
								<div className='left-panel sticky_box'>
									<div className='panel-box'>
										...
										<div className='btn-wrap'>
											<a href={`https://downloads.viralsnare.com/${video?.video}`} className='btn-outline btn-outline-blue'>
												<img src='images/icon-download.svg' className='icon' alt='' />
												Download Video
											</a>
											<a className='btn-outline btn-outline-red' onClick={() => sendNotification(video?.id)}>
												<img src='images/icon-bell.svg' className='icon' alt='' />
												Send Notifications
											</a>
										</div>
									</div>
										...
										<div className='panel-box-info-wrap'>
											...
											<div className='panel-box-info-wrap-col'>
												<p>
													...
													{video?.when_filmed ? video.when_filmed.split('-').join('/') : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Filming Location : </span>
													{video?.city ? video.city : 'N/A'}, {video?.state ? video.state : 'N/A'}, {video?.country ? video.country : 'N/A'}
												</p>
											</div>
										</div>
												...
												<div className='story-description-info'>
													...
													<div className='story-description-info-content'>
														<div className='overflow_scroll'>
															<p>{video?.description ? video.description : 'N/A'}</p>
														</div>
													</div>
												</div>
											</div>
										</div>
										<div className='btn-wrap inline_popup' data-pop-block='url_note'>
											<a href={`https://downloads.viralsnare.com/${video?.video}`} className='btn-outline btn-outline-blue' data-btn='url_note'>
												<img src='images/icon-file-link.svg' className='icon' alt='' />
												Original File
											</a>
												...
												<div className='panel-box-info panel-box-info-xs-spacing mt-0'>
													...
													<form>
														<div className='form-field'>
															<input type='text' placeholder='Enter link' data-text='url_note' />
														</div>
														<div className='message-note-btn'>
															<button type='button' className='btn-outline btn-outline-blue'>
																Save
															</button>
															<button type='button' className='btn-outline btn-outline-red' data-cancel='url_note'>
																Cancel
															</button>
														</div>
													</form>
								...
								<div className='right-panel'>
									<div className='panel-box-info panel-box-info-xs-spacing mt-0'>
										<div className='line-header'>
											...
											<button onClick={() => props.toggle()} className='cross' data-bs-dismiss='modal' aria-label='Close'>
										...
										<div className='panel-box-info-wrap column-4 border-b-0'>
											<div className='panel-box-info-wrap-col'>
												<p>
													...
													{video?.user?.name ? video.user.name : 'N/A'} {video?.user?.last_name ? video.user.last_name : ''}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Email Address: </span>
													{video?.user?.email ? video.user.email : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Phone Number :</span>+{video?.user?.phone ? video.user.phone : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Date of Birth :</span>
													{video?.birthdate ? video.birthdate.split('-').join('/') : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Payment Method : </span> <img src='images/paypal.png' alt='' />
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Paypal Email Address :</span> {video?.paypal_email ? video.paypal_email : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
													<span>Signature : </span> {video?.signature ? <img src={getImageURL(video.signature)} className='signs' alt='' /> : 'N/A'}
												</p>
											</div>
											<div className='panel-box-info-wrap-col'>
												<p>
										...
										<div className='column-wrap'>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Are There People Appearing In the Video? </span>{' '}
														<mark className='stripe-btn-danger'>{video?.people_appearing ? video?.people_appearing : 'No'}</mark>
													</p>
												</div>
												{video?.people_appearing_list && (
													<div className='panel-box-info-wrap-col m-0'>
														<p>
															...
															{video?.people_appearing_list ? video?.people_appearing_list : 'N/A'}
														</p>
													</div>
												)}
											</div>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>The person who filmed this video is </span> {video?.person_who_filmed ? video?.person_who_filmed : 'N/A'}
													</p>
												</div>
											</div>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Did Anyone Reach You About Using This Video?</span>{' '}
														<mark className='stripe-btn-danger'>{video?.did_anyone_reach ? video?.did_anyone_reach : 'N/A'}</mark>
													</p>
												</div>
												{video?.share_reach_name && (
													<>
														<div className='panel-box-info-wrap-col m-0'>
															<p>
																<span>Please Share With Us The Name Of The Company/Page:</span>{' '}
																{video?.share_reach_name ? video?.share_reach_name : 'N/A'}
															</p>
														</div>
													</>
												)}
											...
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														Did You Send/Submit/Upload This Video To A Website And/Or Social Media Account?{' '}
														<mark className='stripe-btn-danger'>{video?.submit_other_website ? video?.submit_other_website : 'N/A'}</mark>
													</p>
												</div>
												{video?.submit_place && (
													<div className='panel-box-info-wrap-col m-0'>
														<p>
															...
															{video?.submit_place ? video?.submit_place : ''}
														</p>
													</div>
												)}
											</div>
											<div className='panel-box-info-wrap column-2'>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Did You Sign A Licensing Agreement For This Video With Another Company/Page?</span>
														<mark className='stripe-btn-danger'>
															{video?.aggrement_with_another_company ? video?.aggrement_with_another_company : 'N/A'}
														</mark>
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Name of the company? </span> {video?.aggrement_company_name ? video?.aggrement_company_name : 'N/A'}
													</p>
												</div>
											</div>
										</div>
										...
										<div className='column-wrap'>
											<div className='panel-box-info-wrap column-4'>
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														<span>User IP address : </span> {video?.video_meta?.ip_address ? video?.video_meta?.ip_address : 'N/A'}
													</p>
												</div>
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														<span>Country : </span> {video?.country ? video.country : 'N/A'}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Submission date :</span> {plainDateTime(video?.created_at)}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Terms of Submission :</span> Agreed | Exclusive License
													</p>
												</div>
											</div>
											<div className='panel-box-info-wrap column-4'>
												...
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														<span>Revenue Share: </span> {video?.user?.revenue_share ? video?.user?.revenue_share + '%' : 'N/A'}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>VSID : </span> {video?.id}
													</p>
												</div>
											...
											<div className='panel-box-info-wrap column-4 p-0'>
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														...
														{video?.status == 1 && (
															<>
																<mark className='stripe-btn-success'>Approved</mark>
															</>
														)}
														{video?.status == 0 && (
															<>
																<mark className='stripe-btn'>Pending</mark>
															</>
														)}
														{video?.status == 2 && (
															<>
																<mark className='stripe-btn-danger'>Rejected</mark>
															</>
														)}
													</p>
												</div>
												<div className='panel-box-info-wrap-col mb-md-0 mb-3'>
													<p>
														<span>Acquired By : </span> {video?.user?.name} {video?.user?.last_name}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>approved or rejected By :</span> {video?.manager?.name} {video?.manager?.last_name}{' '}
														{plainDateTime(video?.video_meta?.manager_updated_at)}
													</p>
												</div>
												<div className='panel-box-info-wrap-col m-0'>
													<p>
														<span>Confirmed or declined By :</span> {video?.quality_team?.name} {video?.quality_team?.last_name}{' '}
